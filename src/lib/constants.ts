...
/**
 * A list of non-archived/still-maintained VueJS repositories, mostly
 * these are just used for the `VueRepository` serializer.
 *
 * Additionally, repos that simply don't have releases are also excluded.
 */
export const VALID_VUEJS_REPOS = [
  'babel-preset-vue',
